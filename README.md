...
•
Draggable & Moveable Clock Card: Long-press the clock to enter Clock Edit Mode. Touch and drag the clock card anywhere on screen to place it freely.
•
Clock Resizing & Scaling: Adjust clock size seamlessly using an interactive slider (60% to 160%) or quick-preset chips.
•
Multiple Minimalist Clock Styles: Horizontal swipe carousel to choose between styles including Large Digital, Minimalist Sans, Monospace, Serene Analog, Word Clock, Atmospheric Glow, and Retro LED.
•
...
•
Phone-Free Today: Real-time total offline focus time reclaimed today.
•
Current Break & Longest Break: Tracks continuous screen-off duration in real-time since your last screen lock and your longest daytime break.
•
Total Weekly Reclaimed Time: Total accumulated offline hours across the last 7 days.
•
Weekly Overview Chart: 7-day progress bars showing exact phone-free hours per day.
•
...
•
Custom Categories: Categorize apps into Communication, Media, Work, Tools, or your own custom categories.
•
